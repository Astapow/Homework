...
--
-- Name: actors_to_films; Type: TABLE; Schema: public; Owner: astapov
--
...
ALTER TABLE public.actors_to_films OWNER TO astapov;
...
COPY public.actors (actor_id, actor_lname, actor_fname, birth_date, film_id, director_id) FROM stdin;
3	Parker	Peter	1962-05-11	2	2
2	Depp	John Christopher	1963-06-09	1	4
1	Chan	Jackie	1954-04-07	3	3
\.


--
-- Data for Name: actors_to_films; Type: TABLE DATA; Schema: public; Owner: astapov
--

COPY public.actors_to_films (actor_id, film_id) FROM stdin;
3	2
2	1
1	3
\.
...
COPY public.directors (director_id, director_lname, director_fname, birth_date, films_amount, actor_id, film_id) FROM stdin;
1	Cameron	James	1954-08-16	9	\N	\N
4	Verbinski	Gregor	1964-03-16	13	2	1
2	Whedon	Joseph Hill	1964-06-23	24	\N	2
3	Bay	Michael Benjamin	1965-02-17	39	\N	3
\.
...
4	Sherlock Holmes	Ritchie	Guy	2009	7.6	\N	\N
